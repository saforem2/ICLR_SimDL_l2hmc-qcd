...
%suffer from the critical slowing down \citet{schaefer2009investigating} of the algorithm.
%
%
...
\begin{enumerate}
   ...
   %defined in terms of the topological charge metric
      %$\(\delta(\xi^{\prime}, \xi)\),
      %
      \begin{equation}
      ...
      {\left(\mathcal{Q}_{\mathbb{R}}^{\prime}-\mathcal{Q}_{\mathbb{R}}\right)}^{2}
         ...
         %\frac{-A(\xi^{\prime}|\xi)\cdot \delta(\xi^{\prime},\xi)}{a^{2}},
      \end{equation}
      %
      %where \(\delta(\xi^{\prime}, \xi) \equiv
