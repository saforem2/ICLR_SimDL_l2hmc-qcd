   ...
   \item We propose a modified loss function
      ...
      \begin{equation}
          \mathcal{L}(\theta) = \mathbb{E}_{p(\xi)}{%
              \left[-\delta(\xi^{\prime}, \xi)\cdot A(\xi^{\prime}|\xi)\right],\quad\text{with}\quad%
...
\begin{figure}[htpb]
   \centering
   \includegraphics[width=\textwidth]{figures/network7.pdf}
...
\begin{equation}
   \mathcal{L}(\theta) = \mathbb{E}_{p(\xi)}{%
      \left[-\delta(\xi^{\prime}, \xi)\cdot A(\xi^{\prime}|\xi)\right]
   }
\end{equation}
%
